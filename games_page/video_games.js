// filter options should be of the form games_Filter-Name-Shown-To-User
...
const videos_table = [
  ...
  },
  {
    ...
    filter_tags: "games_Ghostrunner games_Speedruns",
  },
  {
  ...
  },
  {
    ...
    filter_tags: "games_Astros-Playroom games_Speedruns",
  },
  {
  ...
  },
  {
    ...
    filter_tags: "games_Bloodborne games_Speedrun-Skips",
  },
  {
  ...
  },
  {
    ...
    filter_tags: "games_Ghostrunner games_Glitches",
  },
  {
    title:
...
$(document).ready(function () {
  ...
  var videoContainer = document.getElementById("games-article");
  ...
  function addYoutubeVideo(item) {
    ...
    // Put section and iframe in filterable wrapper
    var newContainerDiv = createElement("div", {
      class: "games-wrapper " + item.filter_tags,
    });
    newContainerDiv.appendChild(newSection);
    newContainerDiv.appendChild(newIframe);
    videoContainer.appendChild(newContainerDiv);
  }
  ...
  function addFilterButton(filterName) {
    ...
    var newButton = createElement("button", {
      ...
      id: filterName,
      type: "checkbox",
      "aria-controls": "games-article",
      "aria-label": "filters page to show only " + filterNameWords,
    });
  ...
  $(".gallery-filter-button").click(function () {
    ...
    switch (activeButtons.length == 0) {
      case true:
        $(".games-wrapper").removeClass("gallery-image-hidden");
        break;
      case false:
        var classCheck = "." + activeButtons.join(".");
        $(".games-wrapper").each(function () {
